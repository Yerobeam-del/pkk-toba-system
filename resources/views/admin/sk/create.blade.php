...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem">
    <div>
        <h1 style="font-size:1.5rem;font-weight:800;color:var(--text-dark);margin:0 0 0.25rem 0">Tambah Dokumen</h1>
        <p style="color:var(--text-muted);margin:0;font-size:0.9rem">Unggah SK atau dokumen baru untuk dikelola</p>
    </div>
...
<div class="card">
    <form action="{{ route('admin.sk.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-bottom:1.5rem">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Contoh: SK Pembentukan Panitia PKK 2024">
